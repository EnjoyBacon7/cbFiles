...
export function CbHeader(props) {
    ...
    return (
        <div className="mt-3">
            ...
            <InputGroup>
                <Button variant="secondary fw-bold" onClick={goHome}>Home</Button>
                <InputGroup.Text className="fw-bold flex-grow-1" variant="secondary" disabled>
                    {shareId}
                </InputGroup.Text>
                <Button variant="outline-secondary" className='d-flex justify-content-center align-items-center' onClick={toggleDarkMode}>
                    {(theme === 'dark') ?
